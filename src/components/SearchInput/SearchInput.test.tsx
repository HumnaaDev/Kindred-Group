...
describe('AutocompleteSearch Component', () => {
    ...
    beforeEach(() => {
        render(<SearchInput setMovieTitle={setMovieTitle} options={mockMovies as Array<IMovie>} />)
    });
    ...
    it('should render the component', () => {
        ...
        expect(screen.getByLabelText('Search for a movie')).toHaveAttribute('type', 'text');
    })
